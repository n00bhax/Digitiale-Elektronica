...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/rood_scherm/rood_scherm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log roodScherm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source roodScherm.tcl
