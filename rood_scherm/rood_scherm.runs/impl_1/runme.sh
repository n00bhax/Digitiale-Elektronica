...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/rood_scherm/rood_scherm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log roodScherm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source roodScherm.tcl -notrace
