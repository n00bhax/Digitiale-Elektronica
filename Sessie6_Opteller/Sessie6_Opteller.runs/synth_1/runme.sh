...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/Sessie6_Opteller/Sessie6_Opteller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Optellen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Optellen.tcl
