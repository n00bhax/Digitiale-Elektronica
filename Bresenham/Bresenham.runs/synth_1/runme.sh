...
HD_PWD='C:/Users/wille/Desktop/Data_D/VivadoProjects/Bresenham/Bresenham.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DrawLine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DrawLine.tcl
