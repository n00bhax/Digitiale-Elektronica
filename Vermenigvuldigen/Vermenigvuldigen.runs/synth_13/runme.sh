...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/Vermenigvuldigen/Vermenigvuldigen.runs/synth_13'
cd "$HD_PWD"
...
EAStep vivado -log Vermenigvuldigen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vermenigvuldigen.tcl
