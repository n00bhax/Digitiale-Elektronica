...
HD_PWD='D:/VivadoProjects/Sessie6_Opteller/Sessie6_Opteller.runs/impl_13'
cd "$HD_PWD"
...
EAStep vivado -log Optellen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Optellen.tcl -notrace
