...
HD_PWD='C:/Universiteit/VivadoProjects/RandomDriehoeken/RandomDriehoeken.runs/TriangleFifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TriangleFifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TriangleFifo.tcl
