...
HD_PWD='C:/Universiteit/VivadoProjects/RandomDriehoeken/RandomDriehoeken.runs/VideoMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VideoMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VideoMemory.tcl
