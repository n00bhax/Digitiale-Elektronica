...
HD_PWD='C:/Universiteit/VivadoProjects/RandomDriehoeken/RandomDriehoeken.runs/ClockingWizard_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockingWizard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockingWizard.tcl
