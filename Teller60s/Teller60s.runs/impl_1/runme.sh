...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/Teller60s/Teller60s.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Klok.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Klok.tcl -notrace
