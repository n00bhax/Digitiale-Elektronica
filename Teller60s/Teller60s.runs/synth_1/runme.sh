...
HD_PWD='C:/Users/wille/Desktop/Data D/VivadoProjects/Teller60s/Teller60s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Klok.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Klok.tcl
